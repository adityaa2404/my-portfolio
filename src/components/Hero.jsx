            ...
            <div className="flex flex-wrap">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        ...
                        <p className="my-0.5 py-6 max-w-xl font-light tracking-tighter text-xl">{HERO_GOAL}</p>
                ...
                <div className="w-full lg:w-1/2 lg:p-8 ">
                    <div className="flex justify-center ">
                        <img src={dp} alt="dp" className="rounded-xl object-cover shadow-lg w-90 h-90 border border-slate-700 hover:border-slate-600 duration-300"></img>
                    </div>
                </div>
            </div>
        </div>
